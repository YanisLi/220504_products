...
if os.path.isfile('61_products/products.csv'):#確認這個檔案存不存在，現在為相對路徑，如不在這個資料夾中，則需要絕對路徑
    print('已找到檔案！')
    with open('61_products/products.csv','r',encoding='utf-8') as p:#把檔案以utf-8格式開啟並讀取
